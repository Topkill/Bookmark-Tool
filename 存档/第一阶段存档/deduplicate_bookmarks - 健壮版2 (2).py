...
def deduplicate_and_generate_report(filepath, mode, decode_enabled):
    ...
    if not duplicate_groups:
        ...
        report_filename = generate_report_file(filepath, duplicate_groups, mode, decode_enabled, total_bookmarks_count, remaining_bookmarks_count)
...
def generate_report_file(original_filepath, duplicate_groups, mode, decode_enabled, total_bookmarks_count, remaining_bookmarks_count):
    """
    生成详细的TXT报告文件。
    """
